    ...
    <>
      <div className="section">
        <div className="about__container container grid">
          {/* Profile photo */}
          <img src={images.neha} alt="about" className="about__img" />
          ...
          <div className="about__data">
            ...
            <p className="about__description">
              ...
              Experienced with <strong>React, Node.js, MongoDB, SQL, AWS</strong>, and strong foundations in <strong>Java</strong>.
